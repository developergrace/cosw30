            ...
            <div class="form">
                ...
                <form action="" method="POST">
                    ...
                    <select name="paragraph" id="paragraph" required>
                        <option value="1" <?php if($paragraph==1) echo 'selected'; ?>>1</option>
                        <option value="2" <?php if($paragraph==2) echo 'selected'; ?>>2</option>
                        <option value="3" <?php if($paragraph==3) echo 'selected'; ?>>3</option>
                        <option value="4" <?php if($paragraph==4) echo 'selected'; ?>>4</option>
                        <option value="5" <?php if($paragraph==5) echo 'selected'; ?>>5</option>
                        <option value="6" <?php if($paragraph==6) echo 'selected'; ?>>6</option>
                        <option value="7" <?php if($paragraph==7) echo 'selected'; ?>>7</option>
                        <option value="8" <?php if($paragraph==8) echo 'selected'; ?>>8</option>
                        <option value="9" <?php if($paragraph==9) echo 'selected'; ?>>9</option>
                        <option value="10" <?php if($paragraph==10) echo 'selected'; ?>>10</option>
                    </select>
